...
X1 <- read_excel("./data/320JourneyDataExtract01Jun2022-07Jun2022.xlsx")
X2 <- read_excel("./data/321JourneyDataExtract08Jun2022-14Jun2022.xlsx")
X3 <- read_excel("./data/322JourneyDataExtract15Jun2022-21Jun2022.xlsx")
X4 <- read_excel("./data/323JourneyDataExtract22Jun2022-28Jun2022.xlsx")
...
save(A, file = "./data/London_June2022.Rdata")
...
bike_loc = read_excel("./data/bike-points.xlsx")
library(ggplot2)
library(ggmap)
library(maps)
library(mapdata)
